...
export default function Home() {
  return (
    <>
      <div className="container max-w-5xl md:max-w-6xl pl-7 sm:pl-20 xl:pl-50 pr-7 sm:pr-20 font-[family-name:var(--font-geist-sans)]">
        ...
        <div className="relative mt-25 sm:mt-45">
          <h1 className="lg:text-[3.5rem] md:text-5xl sm:text-3xl text-2xl font-bold tracking-light">
          ...
          <p className="mt-5 text-base sm:text-xl lg:text-2xl text-gray-300 leading-5.5 sm:leading-8">
